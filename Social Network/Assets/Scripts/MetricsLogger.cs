...
public class MetricsLogger : MonoBehaviour {
	...
	public void LogOnAppointmentEnd(int day, int appointment, int numActions, int numStarsEarned, float timeTaken)
	{
		...
		*/
		...
		ehb.SetEventCategory("Appt");
		ehb.SetEventAction("Success");
		ehb.SetEventLabel(("" + day + "." + appointment));
		ehb.SetEventValue(numStarsEarned);
		ehb.SetCustomMetric(1, "" + numActions);
		ehb.SetCustomMetric(2, "" + timeTaken);
